...
11. As a student, I want to create a question note optionally linked to a reference note or an own-words note, so that I can track gaps in my understanding whether they arise from a source or my own thinking.<br>
- **UI/UX Theme**
...
16. As a user, I want the app to work on mobil, tablet and desktop, so that I can take notes on any device.
17. As a student with learning difficulties, I want the app to meet accessibility standards, so that I can use it without barriers.<br>
