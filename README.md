...
16. As a new user I want to trigger a walkthrough from the home page so that I can understand how the app works before signing up.
<details>
...
- **Sources**
<details>
<summary>19. As a student, I want to see all my sources in a list, so that I can navigate to the one I want to work on.</summary>
...
<details>
<summary>20. As a student I want to be able to create a source, so that I can organise my notes around a single book, course, or subject.
</summary>
Acceptance Criteria:
...
21. As a student, I want to be able to view all my sources filtered by type, so that I can quickly find material of a specific kind such as all my books or all my lectures.
<details>
<summary>22. As a student I want to be able to edit a source name, author, or type, so that I can keep it accurate.</summary>
...
<details>
<summary>23. As a student I want to be able to delete a source with confirmation step when I no longer need it, so that my dashboard stays uncluttered.</summary>
...
<details>
<summary>24. As a student, I want to see all the units within a specific source, so that I can navigate to the unit I want to work on</summary>
...
<details>
<summary>25. As a student I want to be able to create a unit within a source, so that I can organise my notes by topic.</summary>
...
<details>
<summary>26. As a student I want to be able to rename a unit, so that I can keep it aligned with my source structure.</summary>
...
<details>
<summary>27. As a student I want to be able to delete a unit with a confirmation step when I no longer need it, so that I can keep my source structure tidy.</summary>
...
- **Notes**
<details>
<summary>28. As a student I want to be able to see a list of all my notes in a specific unit, organized by type, so that I have an ensemble view of what's done and what's left and easily access the ones I need.</summary>
...
**Reference Notes**
<details>
<summary>29. As a user, I want to view the full content of a reference note, see its location, add linked notes, and view any notes already linked to it, so that I can engage with the material and build on my understanding.</summary>
...
<details>
<summary>30. As a student, I can create a reference note, so that I can track where my information comes from and return to the source when needed.</summary>
...
<details>
<summary>31. As a student I can edit a reference note, so that I can keep my source information accurate</summary>
